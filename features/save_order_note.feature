...
Feature: Save order note
  ...
  Background:
    ...
    And the customer "Johnny Appleseed" addressed it to "street", "12345" "Los Angeles" in the "United States"
    And for the billing address of "Johnny Appleseed" in the "Street", "12345" "Los Angeles", "United States"
  ...
  Scenario: Being able to create order note
    ...
    And I uncheck the checkbox "threebrs_order_message_sendMail"
  ...
  Scenario: Being able to send an order message email to Customer
    When I view the summary of the order "00000001"
    And I write a message
    And I check the checkbox "threebrs_order_message_sendMail"
